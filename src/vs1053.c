...
// static const int GPIO_SCLK = GPIO_NUM_26;
// static const int GPIO_MISO = GPIO_NUM_33;
// static const int GPIO_MOSI = GPIO_NUM_21;
...
void spi_master_init(VS1053_t *dev, int16_t GPIO_SCLK, int16_t GPIO_MISO, int16_t GPIO_MOSI, int16_t GPIO_CS, int16_t GPIO_DCS, int16_t GPIO_DREQ, int16_t GPIO_RESET) {
    esp_err_t ret;
